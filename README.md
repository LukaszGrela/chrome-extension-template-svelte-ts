...
Template for Chrome Extension MV3+ using Vite + Svelte + TypeScript. It is set to have a background worker script and a popup action.
...
- `check` - performs svelte-check diagnostics on the code.
